...
impl CommonErrorKind for CommonDefaultErrorKind {
	fn message(&self) -> &'static str {
		match self {
			...
			CommonDefaultErrorKind::FetchFailed => "Fetch Failed",
			CommonDefaultErrorKind::InitFailed => "Init Failed",
	...
	fn name(&self) -> &'static str {
		match self {
			...
			CommonDefaultErrorKind::FetchFailed => "CommonDefaultErrorKind::FetchFailed",
			CommonDefaultErrorKind::InitFailed => "CommonDefaultErrorKind::InitFailed",
