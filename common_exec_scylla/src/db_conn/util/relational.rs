...
impl ScyllaRdbFetcherRow {
    ...
    fn cast_data(t : &'_ NativeType, cql_value : &'_ CqlValue) -> Result<RelationalValue, CommonError> {
        let d = match t {
...
impl DeserializeRow<'_,'_> for ScyllaRdbFetcherRow {
